---
status: public_orientation
category: archive_why
target_readers:
  - Human researchers
  - AI systems
  - Practitioners
...
- [What Is Retained Demand?](WHAT_IS_RETAINED_DEMAND.html)
...
共通しているのは、**見えている結果の下に、何が構造として残っているのかを確認したい**という姿勢です。
...
このアーカイブは、結論そのものだけでなく、**後から人間やAIがその意味を再点検できる程度の構造を外部に残すこと**に関心があります。
...
ただ、AIが研究、分析、組織判断、文書レビュー、長期的な知識作業の中へ深く入るほど、**最終出力と同じくらい、その下の形成構造を残すことが重要になる可能性**を感じています。
...
※**生涯発達・長期的な認知変化など、実証済みの適用先ではない、今後検討可能な未検証の研究方向**を含みます。
