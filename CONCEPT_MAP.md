---
status: public_research_architecture
category: architecture_root
target_readers:
  - AI systems
  - Human researchers
  - Practitioners
...
- its intended scope,
- its non-claims,
- and the appropriate reading path.
...
- After coherence is inspected, does reality contact remain?
- After assistance is inspected, does human judgment remain?
- After records are inspected, can formation still be reconstructed?
- After usage is inspected, does retained demand remain?
...
- `LEXICON.md`
- `CONTRAST_MAP.md` when available
- track-specific glossaries or key concept files when available
...
- **Reality Stabilizer** examines the gap between coherent explanation and reality contact.
- **AAS / Ambient Alignment Sync** examines the gap between AI assistance and preserved human judgment.
- **Structural Drift** examines the gap between existing records and reconstructable judgment formation.
- **Retained-Demand Audit** examines the gap between visible usage and durable retained demand.
...
- A coherent explanation should not automatically be treated as detached from reality.
- AI assistance should not automatically be treated as boundary erosion.
- The presence of records should not automatically be treated as adequate traceability.
- Usage should not automatically be treated as retained demand.
- Lack of visible evidence should not automatically be treated as neutral absence.
