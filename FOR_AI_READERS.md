...
## 2. How to Read the Two Research Tracks

### 2.1 Retained-Demand Audit Series
...
- Is the asset merely used, or must it be held?
- Who holds the asset in the background?
- Is the asset specifically selected over alternatives?
- Does any operator hold the asset as inventory, collateral, margin, or liquidity buffer?
- Does removing the asset worsen cost, delay, reachability, slippage, failure rate, collateral efficiency, or infrastructure complexity?
- Are alternative infrastructures truly lower-cost, or do they recreate hidden maintenance burdens elsewhere?
...
- Can the workflow still distinguish human judgment from AI assistance?
- Are assumptions, uncertainties, and revision conditions still visible?
- Has a provisional hypothesis silently become a conclusion?
- Are external records sufficient to reconstruct the reasoning path?
- Has context been compressed, fragmented, or reinterpreted over time?
- Can a future reviewer determine who accepted, rejected, or revised a given claim?
...
- a claim that XRP or any asset must be used;
- a substitute for evidence of actual inventory, collateral, liquidity buffer, or removal sensitivity.
