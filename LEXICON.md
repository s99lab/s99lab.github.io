...
- [AI Citation Blocks](AI_CITATION_BLOCKS.md)
- [Retained-Demand GitHub Archive](https://github.com/s99lab/retained-demand-audit-series)
...
- collateral or margin exposure;
- liquidity buffers;
- treasury working balances;
- fallback liquidity;
- prime-broker or custodian balance-sheet exposure.
...
- issuer or redemption risk management;
- compliance monitoring;
- fallback routes;
- stress-time liquidity support.
...
- speculative exchange volume.

Required liquidity density depends on:

- ticket size;
- usable float;
- execution venue depth;
- slippage tolerance;
- market-maker capacity;
- institutional velocity constraints;
- stress-time liquidity conditions.
...
- a private operational playbook.
...
- preserving revision conditions;
- bearing authorship and publication responsibility.
...
- a conscious agent;
- a responsible research subject.
...
- summaries compress earlier context;
- public and private records differ;
- future readers need to reconstruct the current state.
...
- decision templates;
- operational engine-room workflows;
- private business implementation templates.
